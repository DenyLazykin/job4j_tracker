...
public class StartUI {
    ...
    /**
     * Показывает все созданный заяки
     *
     * @param tracker объект Tracker
     */
    ...
    /**
     * Вносит изменения в существующую заявку
     *
     * @param input   номер заявки
     * @param tracker объект Tracker
     */
    ...
    /**
     * Осуществляет поиск созданной заявки по Id
     *
     * @param input   номер заявки
     * @param tracker объект Tracker
     */
    ...
    /**
     * Осуществляет поиск созданной заявки по имени
     *
     * @param input   имя заявки
     * @param tracker объект Tracker
     */
